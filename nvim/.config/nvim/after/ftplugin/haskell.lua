...
vim.keymap.set('n', '<space>hs', ht.hoogle.hoogle_signature, with_desc 'Hoogle: show type signature')
...
vim.keymap.set('n', '<leader>rr', ht.repl.toggle, with_desc 'Toggle GHCi REPL (package)')
...
vim.keymap.set('n', '<leader>rq', ht.repl.quit, with_desc 'Quit GHCi REPL')
